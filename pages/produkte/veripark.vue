...
export default {
	name: 'produkte-veripark',
	async asyncData({ app, store }) {
		let content = await axios.get(`https://admin.conzepta.ch/index.php/wp-json/wp/v2/products?slug=veripark&lang=${app.i18n.locale}`)
		return {
	...
	nuxtI18n: {
		paths: {
			...
			fr: '/produits/veripark', // -> accessible at /fr/a-propos
			de: '/produkte/veripark', // -> accessible at /es/sobre
		},
	},
	data() {
		return {
