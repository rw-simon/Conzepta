			...
			<div class="section">
				<div class="partner">
					...
					<div>
						...
						<a target="_blank" :href="$i18n.locale == 'fr' ? 'https://www.tachifox.com/fr/tachifox-pour-le-chauffeur/' : `https://www.tachifox.com/tachifox-fuer-den-chauffeur`"
						...
						></a>
						<a target="_blank" :href="$i18n.locale == 'de' ? 'https://www.tachifox.com/tachifox-pro-fuer-das-unternehmen/tachifox-pro-anmeldung/' : 'https://www.tachifox.com/fr/tachifox-pro-pour-lentreprise/tachifox-pro-inscription/'"
...
export default {
	...
	async asyncData({ app }) {
		let content = await axios.get(`https://admin.conzepta.ch/index.php/wp-json/wp/v2/products?slug=tachifox&lang=${app.i18n.locale}`)
		return {
